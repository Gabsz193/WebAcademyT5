...
export class DOMManager {
  private produtosTableEl: HTMLElement | null;
  private carrinhoTableEl: HTMLElement | null;
  ...
  renderProdutos(
    ...
    if (!this.produtosTableEl) return;
   ...
   */
  renderCarrinho(carrinho: CarrinhoDeCompras, onRemove: (id: ID) => void): void {
    if (!this.carrinhoTableEl) return;
    ...
    if (totalItensEl) totalItensEl.textContent = totalItens.toString();
