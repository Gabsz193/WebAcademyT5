import { TV, Bicicleta, Celular, Produto } from "./produto.js";
 ...
 */
export function isTV(produto: Produto): produto is TV {
 ...
 */
export function isBicicleta(produto: Produto): produto is Bicicleta {
 ...
 */
export function isCelular(produto: Produto): produto is Celular {
