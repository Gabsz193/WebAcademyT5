"use strict";
const create_task_form = document.querySelector("#submit-task-form");
const todo_list = document.querySelector("#task-list");
const form_input_titulo = document.querySelector("#titulo-input");
const form_input_descricao = document.querySelector("#descricao-input");
const form_input_date_deadline = document.querySelector("#deadline-date-input");
const form_input_time_deadline = document.querySelector("#deadline-time-input");
const list_tasks = [];
...
function createTaskItem(task) {
    ...
    top_section.classList.add("d-flex", "gap-1", "align-items-center", "justify-content-between");
    const title = document.createElement("div");
    title.classList.add("fw-bold");
    title.textContent = task.titulo;
    const status_badge = document.createElement("span");
    status_badge.classList.add("badge", "text-bg-primary", "rounded-pill", "align-self-start");
    ...
    bottom_section.classList.add("d-flex", "justify-content-between", "align-items-end");
...
function reset_form_values() {
    (form_input_titulo === null || form_input_titulo === void 0 ? void 0 : form_input_titulo.value) ? (form_input_titulo.value = "") : undefined;
    (form_input_descricao === null || form_input_descricao === void 0 ? void 0 : form_input_descricao.value) ? (form_input_descricao.value = "") : undefined;
    (form_input_date_deadline === null || form_input_date_deadline === void 0 ? void 0 : form_input_date_deadline.value)
        ? (form_input_date_deadline.value = "")
        : undefined;
    (form_input_time_deadline === null || form_input_time_deadline === void 0 ? void 0 : form_input_time_deadline.value)
        ? (form_input_time_deadline.value = "")
        : undefined;
}
create_task_form === null || create_task_form === void 0 ? void 0 : create_task_form.addEventListener("submit", (e) => {
    e.preventDefault();
    const new_task_titulo = form_input_titulo === null || form_input_titulo === void 0 ? void 0 : form_input_titulo.value;
    const new_task_descricao = form_input_descricao === null || form_input_descricao === void 0 ? void 0 : form_input_descricao.value;
    const new_task_date_deadline = form_input_date_deadline === null || form_input_date_deadline === void 0 ? void 0 : form_input_date_deadline.value;
    const new_task_time_deadline = form_input_time_deadline === null || form_input_time_deadline === void 0 ? void 0 : form_input_time_deadline.value;
    if (new_task_titulo) {
        ...
        todo_list === null || todo_list === void 0 ? void 0 : todo_list.appendChild(createTaskItem(newTask));
    }
    else {
        throw new Error("Os campos título e descrição não foram preenchidos");
    }
    reset_form_values();
    const modalElement = document.querySelector("#submit-task");
    if (modalElement) {
...
function handle_edit_task(e, task) {
    console.log("Aqui");
    (form_input_titulo === null || form_input_titulo === void 0 ? void 0 : form_input_titulo.value)
        ? (form_input_titulo.value = task.titulo)
        : undefined;
    (form_input_descricao === null || form_input_descricao === void 0 ? void 0 : form_input_descricao.value) && task.descricao
